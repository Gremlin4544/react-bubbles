...
- [ ] Explain what a token is used for.
 A token is used to prove that a client is authorized to access certain
 parts of a database.

- [ ] What steps can you take in your web apps to keep your data secure?
You can require authorization tokens in AJAX headers.

- [ ] Describe how web servers work.
  A web server is a computer or series of computers connected to the web that store information at certain URLs and, can deliver that information to clients and run database applications.
